...
class BegenilenPaylasimlar extends StatefulWidget {
  const BegenilenPaylasimlar({super.key});

  @override
  State<BegenilenPaylasimlar> createState() => _BegenilenPaylasimlarState();
}

class _BegenilenPaylasimlarState extends State<BegenilenPaylasimlar> {
  @override
