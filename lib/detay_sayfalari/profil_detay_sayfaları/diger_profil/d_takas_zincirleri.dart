...
class TakasZincirleri extends StatefulWidget {
  const TakasZincirleri({super.key});

  @override
  State<TakasZincirleri> createState() => _TakasZincirleriState();
}

class _TakasZincirleriState extends State<TakasZincirleri> {
  @override
