...
class BegendiginizPaylasimlar extends StatefulWidget {
  const BegendiginizPaylasimlar({super.key});

  @override
  State<BegendiginizPaylasimlar> createState() => _BegendiginizPaylasimlarState();
}

class _BegendiginizPaylasimlarState extends State<BegendiginizPaylasimlar> {
  @override
                            ...
                            children: <Widget>[
                              InkWell(
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => const Detay(
                                          imgPath: 'lib/images/modelgrid2.jpeg')));
                                },
                                child: Hero(
                              ...
                              InkWell(
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => const Detay(
                                          imgPath: 'lib/images/modelgrid3.jpeg')));
                                },
                                child: Hero(
