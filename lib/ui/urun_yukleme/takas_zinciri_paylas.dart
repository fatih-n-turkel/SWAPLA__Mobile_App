...
class ZincirPaylas extends StatefulWidget {
  const ZincirPaylas({Key? key}) : super(key: key);

  @override
  State<ZincirPaylas> createState() => _ZincirPaylasState();
}

class _ZincirPaylasState extends State<ZincirPaylas> {
  Faker faker = Faker();
  double _price = 0;
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: "Daha önceki takasladığınız ürünleri seçiniz",
                              border: const OutlineInputBorder(
                                  borderRadius:
