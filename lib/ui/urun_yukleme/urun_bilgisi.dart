...
class UrunBilgisi extends StatefulWidget {
  const UrunBilgisi({Key? key}) : super(key: key);

  @override
  State<UrunBilgisi> createState() => _UrunBilgisiState();
}

class _UrunBilgisiState extends State<UrunBilgisi> {
  Faker faker = Faker();
  double _price = 0;
              ...
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: "Ürününüzün Başlığını Yazınız",
                ...
                : Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: "Ürün Açıklamasını Yazınız",
                              border: const OutlineInputBorder(
                                  borderRadius:
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            const Text('Ürününüzü gönderi olarak paylaşın'),
                            Checkbox(
                              activeColor: Color.fromRGBO(11, 181, 189, 0.8),
                              value: pageSnapping,
                              onChanged: (b) {
                                setState(() {
                                  pageSnapping = b!;
