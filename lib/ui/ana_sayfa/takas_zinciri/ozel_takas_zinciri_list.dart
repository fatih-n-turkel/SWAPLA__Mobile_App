...
class OzelTakasZinciriList extends StatefulWidget {
  const OzelTakasZinciriList({super.key});

  @override
  State<OzelTakasZinciriList> createState() => _OzelTakasZinciriListState();
}

class _OzelTakasZinciriListState extends State<OzelTakasZinciriList> {
  @override
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: const DecorationImage(
                                    image: AssetImage('lib/images/model3.jpeg'),
                                    fit: BoxFit.cover)),
                          ),
                        ),
                        const SizedBox(
