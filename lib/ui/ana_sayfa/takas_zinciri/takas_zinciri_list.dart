...
class TakasZinciriList extends StatefulWidget {
  const TakasZinciriList({super.key});

  @override
  State<TakasZinciriList> createState() => _TakasZinciriListState();
}

class _TakasZinciriListState extends State<TakasZinciriList> {
  @override
                  ...
                  Row(
                    children: <Widget>[
                      InkWell(
                        ...
                        child: Hero(
                          tag: const NetworkImage('https://picsum.photos/800'),
                          child: Container(
                            height: 200,
                  ...
                  Row(
                    children: <Widget>[
                      InkWell(
                        ...
                        child: Hero(
                          tag: const NetworkImage('https://picsum.photos/100'),
                          child: Container(
                            height: 200,
                            width: (MediaQuery.of(context).size.width - 50) / 2,
                            decoration: BoxDecoration(
