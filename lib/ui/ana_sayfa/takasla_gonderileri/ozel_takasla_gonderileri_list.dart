...
import 'package:Swapla/detay_sayfalari/yorum_yapma/yeni_yorum.dart';
...
import '../../profil/diger_profiller.dart';


class OzelTakaslaGonderileriList extends StatefulWidget {
  const OzelTakaslaGonderileriList({super.key});

  @override
  State<OzelTakaslaGonderileriList> createState() =>
      _OzelTakaslaGonderileriListState();
}

class _OzelTakaslaGonderileriListState
    extends State<OzelTakaslaGonderileriList> {
  @override
          ...
          child: Column(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: true
                    ? NetworkImage('https://picsum.photos/2000')
                    : AssetImage('images/a.png') as ImageProvider,
                fit: BoxFit.cover,
              )),
            ),
          ),
                      ...
                      Column(
                        children: <Widget>[
                          InkWell(
                            ...
                            child: Hero(
            tag: const NetworkImage('https://picsum.photos/200/300'),
            child: Container(
              height: 95,
                                width:
              ...
              decoration: BoxDecoration(
                ...
                fit: BoxFit.cover,
                          ...
                          InkWell(
                            ...
                            child: Hero(
            tag: const NetworkImage('https://loremflickr.com/320/240'),
            child: Container(
              height: 95,
                                width:
                                    (MediaQuery.of(context).size.width - 100) /
                  ...
                  Container(
                    ...
                    child: Center(
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => const EtiketBayanGiyim()));
                        },
                        child: const Text(
                          '# Bayan Giyim',
                          style: TextStyle(
            ...
            content: const Text('Gönderi olarak paylaşıldı'),
            ));
                        },
                        child: Icon(
                          Icons.reply,
